...
//        System.out.println("==============================================");
    ...
    private static void testTelemetryItems() throws IOException {
        ...
        List<TelemetryItem> telemetryItems = deserialize(EXPECTED_TELEMETRY_ITEMS_BYTES);
        ...
        List<TelemetryItem> deserializedTelemetryItems = deserialize(convertByteBufferListToByteArray(serializedByteBuffer));
